...
x1 = layers.Conv2D(3, kernel_size=(3, 3), activation='relu')(matrix_input)
x1 = layers.MaxPooling2D(pool_size=(2, 2))(x1)
x1 = layers.Conv2D(5, kernel_size=(3, 3), activation='relu')(x1)
x1 = layers.MaxPooling2D(pool_size=(2, 2))(x1)
x1 = layers.Conv2D(10, kernel_size=(3, 3), activation='relu')(x1)
...
x1 = layers.Dense(1, activation=None)(x1)
...
x = layers.Multiply()([tf.reshape(x1, (-1, final_dim)), x2])
